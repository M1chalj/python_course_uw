...
df_employees = pd.DataFrame({'First Name': ['Tom', 'Adam', 'Jane', 'Alice', 'Robert', 'Bob', 'John', 'Frank', 'Eva',
                                            'John', 'Lois'],
                             'Last Name': ['Brown', 'Green', 'Thompson', 'Smith', 'Newman', 'Parker', 'Williams',
                                           'Taylor', 'Evans',
                                           'Lewis', 'White'],
                             'Type': ['Full-time Employee', 'Intern', 'Full-time Employee', 'Part-time Employee',
                                      'Full-time Employee', 'Intern', 'Intern', 'Part-time Employee',
                                      'Part-time Employee',
...
table = pd.pivot_table(df_employees, index='Type', values='Salary', aggfunc=['sum', 'mean', 'count'],
                       columns='Department')
